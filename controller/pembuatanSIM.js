const pembuatansimModel = require('../model/Pembuatansim')
const objectId = require('mongoose').Types.ObjectId

//meng create data baru (create)
exports.create= (data) =>
  new Promise((resolve, reject)=> {
    pembuatansimModel.create(data)
      .then(()=> resolve({
        status : true,
